...
const InlineLogo: React.FC<{}> = ({}) => {
    ...
    return(
        <svg id="Inline_logo" data-name="Inline logo" xmlns="http://www.w3.org/2000/svg" width="190" height="38" viewBox="0 0 190 38">
            <g id="Rectangle_3" data-name="Rectangle 3" fill="none" stroke={color} stroke-linejoin="round" stroke-width="2">
            ...
            <text id="MOTO" transform="translate(5 30.5)" fill={color} font-size="30" font-family="'\.AppleSystemUIFont'" font-weight="800"><tspan x="0" y="0">MOTO</tspan></text>
            <text id="GURU" transform="translate(100 29.5)" fill="#fff" font-size="30" font-family="'\.AppleSystemUIFont'" font-weight="700"><tspan x="0" y="0">GURU</tspan></text>
        </svg>
    );
}
