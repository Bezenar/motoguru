import {INLINE_LOGO_DARK} from '../../constants';
...
const InlineLogo: React.FC<{}> = ({}) => {
    return(
        <svg id="Inline_logo" data-name="Inline logo" xmlns="http://www.w3.org/2000/svg" width="190" height="38" viewBox="0 0 190 38">
            <g id="Rectangle_3" data-name="Rectangle 3" fill="none" stroke={INLINE_LOGO_DARK} strokeLinejoin="round" strokeWidth="2">
            ...
            <text id="MOTO" transform="translate(5 30.5)" fill={INLINE_LOGO_DARK} fontSize="30" fontFamily="'\.AppleSystemUIFont'" fontWeight="800"><tspan x="0" y="0">MOTO</tspan></text>
