import {T_ColorsKeys} from '.';

export const light: Record<T_ColorsKeys, string> = {
    primary: '#07C631',
    secondary: '#008D1F',
    gradient: 'linear-gradient(180deg, #CCCCCC 0%, #CCCCCC 5.21%, rgba(204, 204, 204, 0.4) 17.19%, rgba(204, 204, 204, 0.4) 82.81%, #CCCCCC 93.75%, #CCCCCC 100%)',
    'bg-main': '#CCCCCC',
