...
const rus: T_Translations = {
    common: {
        name: 'rus-Name',
        email: 'rus-Email',
        phoneNumber: 'rus-Phone',
        send: 'rus-Send',
        contactUs: 'rus-Contact us',
        message: 'rus-Message',
        sended: 'rus-Sended',
        rate: 'rus-Rate',
        selectDate: 'rus-Select date',
    },
    errors: {
        wrongEmail: 'rus-Wrong email',
        requiredField: 'rus-This field is required',
    },
    header: {
        navigation: {
            home: 'rus-HOMEPAGE',
    ...
    footer: {
        contacts: {
            heading: 'rus-Contact info',
            address: 'rus-Brivibas street 100 - 11',
        },
    },
    homepage: {
        banner: {
            title: 'rus-MOTOGURU MOTOSCHOOL',
            subHeading: 'rus-Come study with us...Some extra text',
        },
        about: {
        ...
        features: {
            1: {
                text: 'rus-Introductory lesson',
                btnValue: 'rus-Contact us',
            },
            2: {
                text: 'rus-Introductory lesson',
                btnValue: 'rus-Contact us',
    ...
    categories: {
        ...
        theory: {
            heading: 'rus-Upcoming theory classes',
            table: {
                head: {
