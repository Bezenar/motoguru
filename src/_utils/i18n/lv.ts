...
const lv: T_Translations = {
    common: {
        name: 'lv-Name',
        email: 'lv-Email',
        phoneNumber: 'lv-Phone',
        send: 'lv-Send',
        contactUs: 'lv-Contact us',
        message: 'lv-Message',
        sended: 'lv-Sended',
        rate: 'lv-Rate',
        selectDate: 'lv-Select date',
    },
    errors: {
        wrongEmail: 'lv-Wrong email',
        requiredField: 'lv-This field is required',
    },
    header: {
        navigation: {
            home: 'lv-HOMEPAGE',
    ...
    homepage: {
        ...
        features: {
            1: {
                text: 'lv-Introductory lesson',
                btnValue: 'lv-Contact us',
            },
            2: {
                text: 'lv-Introductory lesson',
                btnValue: 'lv-Contact us',
    ...
    categories: {
        ...
        theory: {
            heading: 'lv-Upcoming theory classes',
            table: {
                head: {
